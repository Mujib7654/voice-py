...
def yt():
    ...
    driver = webdriver.Chrome(
        r"C:/Users/shivam/.wdm/drivers/chromedriver/win32/91.0.4472.101/chromedriver.exe "
    )
   # driver.maximize_window()
    talk("Opening Youtube"
         "which video you want me to play")
    querry = rec_audio()
    driver.get("http://www.youtube.com/results?search_query=" + querry)
    try:
...
def sfy():
   ...
   # driver.maximize_window()
    ...
    querry = rec_audio()
    driver.get('https://open.spotify.com/search/' + querry)
    try:
        driver.find_element_by_xpath('//*[@id="searchPage"]/div/div/section[2]/div[2]/div/div/div/div[2]/div[1]/div/div[1]/div[1]/button/svg/polygon').click()
    ...
    try:
        ...
        if call(text):
            ...
            if "date" in text or "day" in text or "month" in text:
                ...
                img = r"C:\Users\shivam\OneDrive\Pictures\wallpapers"
                ...
                key = "db9eb9df770a237cd9e6b6af69f25e13"
                ...
                url = (
                    "https://newsapi.org/v2/top-headlines?country=in&apiKey=c60e5cf053eb4c248d93b7189b26780b "
                )
            ...
            elif "play youtube" in text.lower():
                yt()

            elif "play spotify" in text.lower():
                sfy()
